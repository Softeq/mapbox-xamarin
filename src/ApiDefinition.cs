...
namespace MapboxBindingIOS
{
    ...
    //[Static]
    //partial interface MGLCoordinateSpanZero
    //{
    ...
    interface MGLMapViewDelegate
    {
        ...
        [return: NullAllowed]
        UIImage MapView(MGLMapView mapView, string imageName);
    ...
    [Static]
    partial interface NSNotificationName
    {
    ...
    [Static]
    partial interface MGLExceptionName
    {
        // extern const  _Nonnull MGLAbstractClassException __attribute__((visibility("default")));
        ...
        // extern const  _Nonnull MGLInvalidStyleLayerException __attribute__((visibility("default")));
    ...
    interface MGLShapeSource
    {
        ...
        NSObject[] LeavesOfCluster(MGLPointFeatureCluster cluster, nuint offset, nuint limit);

        // -(NSArray<id<MGLFeature>> * _Nonnull)childrenOfCluster:(MGLPointFeatureCluster * _Nonnull)cluster;
        [Export("childrenOfCluster:")]
        NSObject[] ChildrenOfCluster(MGLPointFeatureCluster cluster);
    ...
    {
        // extern const  _Nonnull MGLExpressionInterpolationModeLinear __attribute__((visibility("default")));
    ...
    [Static]
    partial interface MGLAttributedExpressionKey
    {
        // extern const  _Nonnull MGLFontNamesAttribute __attribute__((visibility("default")));
